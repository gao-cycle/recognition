...
log_dir = os.path.join('tensorboard', 'test_vgg')
...
annotation_path2='file/cls_val.txt'#读取数据集生成的文件
with open(annotation_path2,'r') as f:
    lines2=f.readlines()
...
val_data=DataGenerator(lines[:num_val],input_shape,False)
...
for epoch in range(epochs):
    ...
    test_writer.add_scalar('Accuracy', total_accuracy / val_len, epoch)
    test_writer.add_scalar('loss', total_train, epoch)
