...
log_dir = os.path.join('tensorboard', 'test_ResNet')
...
def main():
    ...
    model_weight_path = "Offline/resnet34-333f7ec4.pth"
    ...
    net.fc = nn.Linear(in_channel, 2)  # (5分类)
    net.to(device)
    ...
    epochs = 10
    save_path = "Offline/ResNet34_GPU.pth"
    best_accuracy = 0.0
